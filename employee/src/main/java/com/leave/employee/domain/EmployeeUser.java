...
public class EmployeeUser {
	...
	public EmployeeUser(@NotEmpty(message = "userName should not be empty") String userName, Integer employeeId,
			@NotEmpty(message = "emailId should not be empty") String emailId) {
		super();
		this.userName = userName;
